...
//        reverseArray(BlueBits);
    ...
    public String BitmapToText(BufferedImage encodedImage, int width, int height) {
        ...
        for (int j = 3; j < 16; j++) {
            ...
            Color pixelToDecode = new Color((int) encodedImage.getRGB((int) (width - j - 1), (int) (height - 1)));
