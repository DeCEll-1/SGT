...
public class ReflectionWorks {
    ...
    public static String GetVariableName(Object field) throws Throwable {
        VeBlib_Logger.log(ReflectionWorks.class, "Get Field Class - Get Variable Name");
        final Class<?> fieldClass = Class.forName("java.lang.reflect.Field", false, Class.class.getClassLoader());

        VeBlib_Logger.log(ReflectionWorks.class, "Find Virtual - Set Access");
    ...
    public static void SetVariable(Object field, Object thingToSetTo, Object setValue) throws Throwable {
        VeBlib_Logger.log(ReflectionWorks.class, "Get Field Class - Set Variable");
        final Class<?> fieldClass = Class.forName("java.lang.reflect.Field", false, Class.class.getClassLoader());
        ...
        VeBlib_Logger.log(ReflectionWorks.class, "Set Value Method");
        ...
        VeBlib_Logger.log(ReflectionWorks.class, "Set Variable Method - Invoke ");
    ...
    public static BufferedImage GetBufferedImage(String filePath) throws Throwable {
        ...
        VeBlib_Logger.log(ReflectionWorks.class, "Get File Class");
        final Class<?> fileClass = Class.forName("java.io.File", false, Class.class.getClassLoader());
        VeBlib_Logger.log(ReflectionWorks.class, "Get File Constructor");
        Constructor<?> fileConstructor = fileClass.getConstructor(String.class);
        VeBlib_Logger.log(ReflectionWorks.class, "Construct File Object");
...
//        Object file = (Object) fileConstructor.newInstance((String) filePath);
        ...
        VeBlib_Logger.log(ReflectionWorks.class, "Get ImageIO Class");
        final Class<?> imageioClass = Class.forName("javax.imageio.ImageIO", true, Class.class.getClassLoader());

        VeBlib_Logger.log(ReflectionWorks.class, "Find Static - ImageIO Read");
